...
# example : make goose-up
	@echo " >> Installing goose if not installed"
	@go install github.com/pressly/goose/v3/cmd/goose@latest
	@goose -dir scripts/migrations/sql postgres "host=library.c3e668qy2v57.ap-southeast-1.rds.amazonaws.com user=admin1 password=onepiece21012123op dbname=library_auth sslmode=disable" up

goose-down:
# example : make goose-down
	@echo " >> Installing goose if not installed"
	@go install github.com/pressly/goose/v3/cmd/goose@latest
	@goose -dir scripts/migrations/sql postgres "host=library.c3e668qy2v57.ap-southeast-1.rds.amazonaws.com user=admin1 password=onepiece21012123op dbname=library_auth sslmode=disable" down

goose-status:
# example : make goose-status
	@echo " >> Installing goose if not installed"
	@go install github.com/pressly/goose/v3/cmd/goose@latest
	@goose -dir scripts/migrations/sql postgres "host=library.c3e668qy2v57.ap-southeast-1.rds.amazonaws.com user=admin1 password=onepiece21012123op dbname=library_auth sslmode=disable" status
